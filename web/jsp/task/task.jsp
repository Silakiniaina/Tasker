            ...
            <div>
                <span class="d-flex row task-card" style="background-color: #FFFFFF;">
                    ...
                    <div class="task-config col-md-5">
                        <div class="d-flex" style="align-items: center; height: 30%; width: 130px; padding: 4px 8px; border-radius: 15px; gap: 5px; background-color: rgb(195, 233, 195); color: rgb(38, 141, 38); text-align: center;">
                        ...
                        <div class="d-flex" style="gap: 5px; padding: 5px 2px;">
                            <div>
