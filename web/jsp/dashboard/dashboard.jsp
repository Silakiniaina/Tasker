    ...
    <%
        HashMap<String, Integer> number = (HashMap<String, Integer>)request.getAttribute("numberCollaborator");
        HashMap<String, Integer> project = (HashMap<String, Integer>)request.getAttribute("numberProject");
    %>
    <%@include file ="../shared/sidebar.jsp" %>
    <h1 class="title">Collaborators inscrits</h1>
    ...
    <h1 class="title">Project created</h1>
    <div class="numbers row d-flex align-item-center g-3 justify-content-flex-start">
        <div class="numbers__item col-md-3">
            <span class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor"
            ...
            <div class="numbers__item-content">
                <h3 class="number_title">Total</h3>
                <p class="item-value"><%= project != null ? project.get("total") : "0" %></p>
            </div>
        </div>
        <div class="numbers__item col-md-3">
            <span class="icon">
            ...
            <div class="numbers__item-content">
                <h3 class="number_title">This year</h3>
                <p class="item-value"><%= project != null ? project.get("year") : "0" %></p>
            </div>
        </div>
        <div class="numbers__item col-md-3">
            <span class="icon">
            ...
            <div class="numbers__item-content">
                <h3 class="number_title">This months</h3>
                <p class="item-value"><%= project != null ? project.get("month") : "0" %></p>
            </div>
        </div>
    </div>